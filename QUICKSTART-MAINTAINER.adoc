...
// Replace rescript-evangeliser, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= rescript-evangeliser — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining rescript-evangeliser for
...
podman build -t rescript-evangeliser .
----
...
* Upstream: https://github.com/hyperpolymath/rescript-evangeliser/issues
