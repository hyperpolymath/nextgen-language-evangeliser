...
// Replace rescript-evangeliser, Rescript Evangeliser — See README.adoc for details., just run, Rescript Evangeliser started successfully. with actuals
= rescript-evangeliser — Quick Start for Users
:toc:
:toclevels: 2

== What is rescript-evangeliser?

Rescript Evangeliser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./rescript-evangeliser-portable
----
...
[source]
----
Rescript Evangeliser started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/rescript-evangeliser/wiki
