...
// Replace nextgen-languages-evangeliser, Nextgen Languages Evangeliser — See README.adoc for details., just run, Nextgen Languages Evangeliser started successfully. with actuals
= nextgen-languages-evangeliser — Quick Start for Users
:toc:
:toclevels: 2

== What is nextgen-languages-evangeliser?

Nextgen Languages Evangeliser — See README.adoc for details.
...
[source]
----
Nextgen Languages Evangeliser started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/nextgen-languages-evangeliser/wiki
